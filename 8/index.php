        ...
        <script>
            $(function(){
                $('.slide-out-div').tabSlideOut({
                    ...
                    pathToTabImage: 'images/pull_tab.png',          //path to the image for the tab (optionaly can be set using css)
                    imageHeight: '112px',  							//height of tab image
                    imageWidth: '215px',                               //width of tab image
    ...
    <body onload="getMenu('city'); loadMap('map_canvas'); populate('', '')">
        <div class="banner">
            ...
            <div id="logos">
                ...
                <a href="https://twitter.com/UCIAA" target="_blank"><img src="images/twitter_logo2.png" width="40px"/>
