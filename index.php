...
<body>
  <div class="page-container">
      ...
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <ul class="nav pull-right">
            <li class="dropdown">
              <a class="dropdown-toggle" id="js-menu" data-toggle="dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a class="js-clusters">
                    <i class="icon-check-empty" id="js-clusters-menu"></i> Clusters
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#update" data-toggle="modal">
                    <i class="icon-pencil"></i> Update Info
                  </a>
                </li>
              </ul>
            </li>
    ...
    <div id="about" class="modal hide fade" tabindex="-1" data-modaloverflow="true">
      <div class="modal-header">
        <button class="close" data-dismiss="modal" type="button">&times;</button>
        <h3>About</h3>
      </div>
      <div class="modal-body">
        <p class="text-center"><img src="img/antnet_logo_full.png" alt="Anteater Network"></p>
        ...
        <p>Anteater Network &copy; 2013 JMMP and the UC Irvine Alumni Association<br />
        <small>Requires Internet Explorer 8+, Chrome, Safari, Firefox, or Opera.</small></p>
        <a href="https://github.com/JMMP"><img src="img/jmmp_logo.png" alt="JMMP"></a><a href="alumni.uci.edu"><img src="img/uciaa_logo.png" alt="UCIAA"></a>
